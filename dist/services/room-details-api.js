...
exports.RoomDetailsApi = exports.RoomDetailsApiFactory = exports.RoomDetailsApiFp = exports.RoomDetailsApiAxiosParamCreator = void 0;
 ...
 * @export
 */
const RoomDetailsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         *
        ...
        roomDetailControllerCreate: (createRoomDetailDto_1, ...args_1) => __awaiter(this, [createRoomDetailDto_1, ...args_1], void 0, function* (createRoomDetailDto, options = {}) {
            ...
            (0, common_1.assertParamExists)('roomDetailControllerCreate', 'createRoomDetailDto', createRoomDetailDto);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(createRoomDetailDto, localVarRequestOptions, configuration);
            return {
        ...
        roomDetailControllerFindOne: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            ...
            (0, common_1.assertParamExists)('roomDetailControllerFindOne', 'id', id);
        ...
        roomDetailControllerRemove: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('roomDetailControllerRemove', 'id', id);
            const localVarPath = `/api/room-details/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
        ...
        roomDetailControllerRestore: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('roomDetailControllerRestore', 'id', id);
        ...
        roomDetailControllerUpdate: (id_1, updateRoomDetailDto_1, ...args_1) => __awaiter(this, [id_1, updateRoomDetailDto_1, ...args_1], void 0, function* (id, updateRoomDetailDto, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('roomDetailControllerUpdate', 'id', id);
            // verify required parameter 'updateRoomDetailDto' is not null or undefined
            (0, common_1.assertParamExists)('roomDetailControllerUpdate', 'updateRoomDetailDto', updateRoomDetailDto);
            const localVarPath = `/api/room-details/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(updateRoomDetailDto, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.RoomDetailsApiAxiosParamCreator = RoomDetailsApiAxiosParamCreator;
/**
 * RoomDetailsApi - functional programming interface
 * @export
 */
const RoomDetailsApiFp = function (configuration) {
    const localVarAxiosParamCreator = (0, exports.RoomDetailsApiAxiosParamCreator)(configuration);
    return {
        /**
         *
         * @summary Create a new room detail
        ...
        roomDetailControllerCreate(createRoomDetailDto, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomDetailsApi.roomDetailControllerCreate']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        roomDetailControllerFindDeleted(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomDetailsApi.roomDetailControllerFindDeleted']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomDetailControllerFindMany(page, pageSize, filters, sort, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomDetailsApi.roomDetailControllerFindMany']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomDetailControllerFindManyInfinite(page, pageSize, filters, sort, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomDetailsApi.roomDetailControllerFindManyInfinite']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomDetailControllerFindOne(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomDetailsApi.roomDetailControllerFindOne']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomDetailControllerRemove(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomDetailsApi.roomDetailControllerRemove']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomDetailControllerRestore(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomDetailsApi.roomDetailControllerRestore']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomDetailControllerUpdate(id, updateRoomDetailDto, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomDetailsApi.roomDetailControllerUpdate']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
};
exports.RoomDetailsApiFp = RoomDetailsApiFp;
/**
 * RoomDetailsApi - factory interface
 * @export
 */
const RoomDetailsApiFactory = function (configuration, basePath, axios) {
    const localVarFp = (0, exports.RoomDetailsApiFp)(configuration);
    return {
        /**
         *
         * @summary Create a new room detail
...
exports.RoomDetailsApiFactory = RoomDetailsApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
class RoomDetailsApi extends base_1.BaseAPI {
    /**
     *
     * @summary Create a new room detail
     * @param {RoomDetailsApiRoomDetailControllerCreateRequest} requestParameters Request parameters.
     ...
     */
    roomDetailControllerCreate(requestParameters, options) {
        return (0, exports.RoomDetailsApiFp)(this.configuration).roomDetailControllerCreate(requestParameters.createRoomDetailDto, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get all soft-deleted room details
     ...
     */
    roomDetailControllerFindDeleted(options) {
        return (0, exports.RoomDetailsApiFp)(this.configuration).roomDetailControllerFindDeleted(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get all room details with pagination and filters
     ...
     */
    roomDetailControllerFindMany(requestParameters = {}, options) {
        return (0, exports.RoomDetailsApiFp)(this.configuration).roomDetailControllerFindMany(requestParameters.page, requestParameters.pageSize, requestParameters.filters, requestParameters.sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get all room details with infinite pagination and filters
     ...
     */
    roomDetailControllerFindManyInfinite(requestParameters = {}, options) {
        return (0, exports.RoomDetailsApiFp)(this.configuration).roomDetailControllerFindManyInfinite(requestParameters.page, requestParameters.pageSize, requestParameters.filters, requestParameters.sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get a room detail by id
     ...
     */
    roomDetailControllerFindOne(requestParameters, options) {
        return (0, exports.RoomDetailsApiFp)(this.configuration).roomDetailControllerFindOne(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Soft delete a room detail
     ...
     */
    roomDetailControllerRemove(requestParameters, options) {
        return (0, exports.RoomDetailsApiFp)(this.configuration).roomDetailControllerRemove(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Restore a soft-deleted room detail
     ...
     */
    roomDetailControllerRestore(requestParameters, options) {
        return (0, exports.RoomDetailsApiFp)(this.configuration).roomDetailControllerRestore(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Update a room detail
     ...
     */
    roomDetailControllerUpdate(requestParameters, options) {
        return (0, exports.RoomDetailsApiFp)(this.configuration).roomDetailControllerUpdate(requestParameters.id, requestParameters.updateRoomDetailDto, options).then((request) => request(this.axios, this.basePath));
    }
}
exports.RoomDetailsApi = RoomDetailsApi;
