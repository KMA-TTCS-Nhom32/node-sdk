...
exports.RoomPromotionsApi = exports.RoomPromotionsApiFactory = exports.RoomPromotionsApiFp = exports.RoomPromotionsApiAxiosParamCreator = void 0;
 ...
 * @export
 */
const RoomPromotionsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         *
        ...
        roomPromotionControllerCreate: (createRoomPromotionDto_1, ...args_1) => __awaiter(this, [createRoomPromotionDto_1, ...args_1], void 0, function* (createRoomPromotionDto, options = {}) {
            ...
            (0, common_1.assertParamExists)('roomPromotionControllerCreate', 'createRoomPromotionDto', createRoomPromotionDto);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(createRoomPromotionDto, localVarRequestOptions, configuration);
            return {
        ...
        roomPromotionControllerFindOne: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            ...
            (0, common_1.assertParamExists)('roomPromotionControllerFindOne', 'id', id);
        ...
        roomPromotionControllerRemove: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('roomPromotionControllerRemove', 'id', id);
            const localVarPath = `/api/room-promotions/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
        ...
        roomPromotionControllerRestore: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('roomPromotionControllerRestore', 'id', id);
        ...
        roomPromotionControllerUpdate: (id_1, updateRoomPromotionDto_1, ...args_1) => __awaiter(this, [id_1, updateRoomPromotionDto_1, ...args_1], void 0, function* (id, updateRoomPromotionDto, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('roomPromotionControllerUpdate', 'id', id);
            // verify required parameter 'updateRoomPromotionDto' is not null or undefined
            (0, common_1.assertParamExists)('roomPromotionControllerUpdate', 'updateRoomPromotionDto', updateRoomPromotionDto);
            const localVarPath = `/api/room-promotions/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(updateRoomPromotionDto, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        roomPromotionControllerValidatePromotionCode: (code_1, roomDetailId_1, ...args_1) => __awaiter(this, [code_1, roomDetailId_1, ...args_1], void 0, function* (code, roomDetailId, options = {}) {
            ...
            (0, common_1.assertParamExists)('roomPromotionControllerValidatePromotionCode', 'code', code);
            // verify required parameter 'roomDetailId' is not null or undefined
            (0, common_1.assertParamExists)('roomPromotionControllerValidatePromotionCode', 'roomDetailId', roomDetailId);
...
exports.RoomPromotionsApiAxiosParamCreator = RoomPromotionsApiAxiosParamCreator;
/**
 * RoomPromotionsApi - functional programming interface
 * @export
 */
const RoomPromotionsApiFp = function (configuration) {
    const localVarAxiosParamCreator = (0, exports.RoomPromotionsApiAxiosParamCreator)(configuration);
    return {
        /**
         *
         * @summary Create a new room promotion
        ...
        roomPromotionControllerCreate(createRoomPromotionDto, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomPromotionsApi.roomPromotionControllerCreate']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        roomPromotionControllerFindDeleted(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomPromotionsApi.roomPromotionControllerFindDeleted']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomPromotionControllerFindMany(page, pageSize, filters, sort, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomPromotionsApi.roomPromotionControllerFindMany']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomPromotionControllerFindOne(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomPromotionsApi.roomPromotionControllerFindOne']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomPromotionControllerRemove(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomPromotionsApi.roomPromotionControllerRemove']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomPromotionControllerRestore(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomPromotionsApi.roomPromotionControllerRestore']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomPromotionControllerUpdate(id, updateRoomPromotionDto, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomPromotionsApi.roomPromotionControllerUpdate']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        roomPromotionControllerValidatePromotionCode(code, roomDetailId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['RoomPromotionsApi.roomPromotionControllerValidatePromotionCode']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
};
exports.RoomPromotionsApiFp = RoomPromotionsApiFp;
/**
 * RoomPromotionsApi - factory interface
 * @export
 */
const RoomPromotionsApiFactory = function (configuration, basePath, axios) {
    const localVarFp = (0, exports.RoomPromotionsApiFp)(configuration);
    return {
        /**
         *
         * @summary Create a new room promotion
...
exports.RoomPromotionsApiFactory = RoomPromotionsApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
class RoomPromotionsApi extends base_1.BaseAPI {
    /**
     *
     * @summary Create a new room promotion
     * @param {RoomPromotionsApiRoomPromotionControllerCreateRequest} requestParameters Request parameters.
     ...
     */
    roomPromotionControllerCreate(requestParameters, options) {
        return (0, exports.RoomPromotionsApiFp)(this.configuration).roomPromotionControllerCreate(requestParameters.createRoomPromotionDto, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get all soft-deleted room promotions
     ...
     */
    roomPromotionControllerFindDeleted(options) {
        return (0, exports.RoomPromotionsApiFp)(this.configuration).roomPromotionControllerFindDeleted(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get all room promotions with pagination and filters
     ...
     */
    roomPromotionControllerFindMany(requestParameters = {}, options) {
        return (0, exports.RoomPromotionsApiFp)(this.configuration).roomPromotionControllerFindMany(requestParameters.page, requestParameters.pageSize, requestParameters.filters, requestParameters.sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get room promotion by ID
     ...
     */
    roomPromotionControllerFindOne(requestParameters, options) {
        return (0, exports.RoomPromotionsApiFp)(this.configuration).roomPromotionControllerFindOne(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Delete a room promotion
     ...
     */
    roomPromotionControllerRemove(requestParameters, options) {
        return (0, exports.RoomPromotionsApiFp)(this.configuration).roomPromotionControllerRemove(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Restore a soft-deleted room promotion
     ...
     */
    roomPromotionControllerRestore(requestParameters, options) {
        return (0, exports.RoomPromotionsApiFp)(this.configuration).roomPromotionControllerRestore(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Update a room promotion
     ...
     */
    roomPromotionControllerUpdate(requestParameters, options) {
        return (0, exports.RoomPromotionsApiFp)(this.configuration).roomPromotionControllerUpdate(requestParameters.id, requestParameters.updateRoomPromotionDto, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Validate a promotion code for a specific room
     ...
     */
    roomPromotionControllerValidatePromotionCode(requestParameters, options) {
        return (0, exports.RoomPromotionsApiFp)(this.configuration).roomPromotionControllerValidatePromotionCode(requestParameters.code, requestParameters.roomDetailId, options).then((request) => request(this.axios, this.basePath));
    }
}
exports.RoomPromotionsApi = RoomPromotionsApi;
