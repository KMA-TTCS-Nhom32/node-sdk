...
/**
    ...
    * @enum {string}
    */
export declare enum FilterBookingsDtoStatusEnum {
    Pending = "PENDING",
...
/**
    ...
    * @enum {string}
    */
export declare enum FilterBookingsDtoTypeEnum {
    Hourly = "HOURLY",
    Nightly = "NIGHTLY",
    Daily = "DAILY"
}
/**
    ...
    * @enum {string}
    */
export declare enum FilterBookingsDtoPaymentStatusEnum {
    Unpaid = "UNPAID",
    Paid = "PAID",
    Failed = "FAILED",
    Refunded = "REFUNDED"
...
/**
    ...
    * @enum {string}
    */
export declare enum FilterBookingsDtoPaymentMethodEnum {
    Cash = "CASH",
    Banking = "BANKING",
    Zalopay = "ZALOPAY",
    Momo = "MOMO",
