...
/**
    ...
    * @enum {string}
    */
export declare enum FilterRoomDetailDtoRoomTypeEnum {
    Standard = "STANDARD",
    Superior = "SUPERIOR",
    Deluxe = "DELUXE"
}
/**
    ...
    * @enum {string}
    */
export declare enum FilterRoomDetailDtoBedTypeEnum {
    Single = "SINGLE",
    Double = "DOUBLE",
    Queen = "QUEEN",
    King = "KING"
...
/**
    ...
    * @enum {string}
    */
export declare enum FilterRoomDetailDtoBookingTypeEnum {
    Hourly = "HOURLY",
    Nightly = "NIGHTLY",
    Daily = "DAILY"
}
